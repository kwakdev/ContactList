...
// Define a fragment that allows adding an email contact
class AddEmailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val btnSubmitEmail = view.findViewById<Button>(R.id.btnSubmitEmail)
        ...
        btnSubmitEmail.setOnClickListener {
            ...
            val contact = Contact(contactName, emailAddress)
